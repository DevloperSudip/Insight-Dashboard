						...
						<div class="addemp_div_design bg-light">
							...
							<form:form action="saleCourseForm" method="post" modelAttribute="modelSaleCourseAttr">
								 <div class="mb-3">
									...
									<form:input path="custphoneno"  name="custphoneno" id="custphoneno" cssClass="form-control" />
									<form:errors path="custphoneno" cssClass="error_message_design" />
								</div> 
								
								<div class="mb-3">
									<label class="form-label">Start-Date</label>
									<input type="date"   name="date1" id="date1" placeholder="DD-MM-YYYY" pattern="\d{2}-\d{2}-\d{4}"  Class="form-control" />
									<form:errors path="custphoneno" cssClass="error_message_design" />
								</div>
