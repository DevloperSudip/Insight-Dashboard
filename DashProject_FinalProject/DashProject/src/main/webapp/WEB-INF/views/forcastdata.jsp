				...
				<div class="row">
					...
					<div class="col-6 d-flex justify-content-center">
						<div class="addemp_div_design bg-light">
							...
							<br />
							<form:form action="forcastGraph" method="post" modelAttribute="modelSaleCourseAttr">
								<div class="mb-3">
									<label class="form-label">Start-Date</label>
									<input type="date"   name="startdate" id="startdate" placeholder="DD-MM-YYYY" pattern="\d{2}-\d{2}-\d{4}"  Class="form-control" />
									<form:errors path="custphoneno" cssClass="error_message_design" />
								</div>
								
								<div class="mb-3">
									<label class="form-label">Interested Course</label>
									<form:select path="coursename" name="coursename" id="coursename" cssClass="form-select" onchange="getSelectedCourse()">
