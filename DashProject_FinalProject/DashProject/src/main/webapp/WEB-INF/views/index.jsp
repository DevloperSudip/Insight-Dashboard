        ...
        <div class="container-fluid">
            <div class="row main_page_banner">
                <div class="col-8" style="padding: 50px">
                    <span class="main_page_title"> Dash Application empowers a global network of over 250,000 businesses in 180 countries to convert more leads, engage with customers, and grow their revenue.</span>
                </div>
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="row" style="padding-top: 50px">
                    <div class="col-6">
                        <h3>What does Dash do?</h3>
                        <ul>
                            <li>Actively tracks and manages Stock information.</li>
                    ...
                    <div class="col-6">
                        <h3>Why Dash matters?</h3>
                        <ul>
                            <li>Dash helps you ditch clunky processes and manual effort so you can get on with business.</li>
