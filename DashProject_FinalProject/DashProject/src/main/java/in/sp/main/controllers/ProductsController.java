...
public class ProductsController
{
			...
			RedirectAttributes redirectAttributes)
	{
		...
		String empemail = "admin@gmail.com";
		...
		//==========================================================//
		/*
		 * LocalDate ld = LocalDate.now(); String date1 =
		...
		saleCourse.setCoursename(coursename);
		saleCourse.setCustphoneno(custphoneno);
		saleCourse.setEmpemailid(empemail);
		saleCourse.setDate(formattedDate);
